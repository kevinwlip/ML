AWS Blogs: https://aws.amazon.com/blogs/machine-learning/build-tune-and-deploy-an-end-to-end-churn-prediction-model-using-amazon-sagemaker-pipelines/
GitHub: https://github.com/aws-samples/customer-churn-sagemaker-pipelines-sample/blob/main/README.md


To Run:
1. Have the 'Run' folder in Sagemaker Jupyter
2. Have data file in "s3://{default_bucket}/data/storedata_total.csv"
3. Run 'Customer_Churn_Modeling.ipynb' in Jupyter
4. Run 'SageMaker_Pipelines_project.ipynb' in Jupyter


KIP NOTES: 
1. Need to request AWS Service Quota Resources: 
    a. ml.m5.xlarge for processing job usage
    b. ml.m5.xlarge for transform job usage

2. Need to update batch.csv and baseline.csv
    a. Update all 'True' values to '1.0' and all 'False' values to '0.0' in batch.csv
    b. Update all 'True' values to '1.0' and all 'False' values to '0.0' in baseline.csv
